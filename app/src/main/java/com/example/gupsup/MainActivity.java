...
import com.example.gupsup.Profile.ProfileActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setViewPager2(){
        ...
        Adapter adapters=new Adapter(getSupportFragmentManager(),FragmentPagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
